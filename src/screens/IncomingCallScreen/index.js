...
const IncomingCallScreen = () => {
  ...
  // get the caller's details, and listen to reject calls or disconnected calls
  useEffect(() => {
  ...
  return (
    <ImageBackground source={bg} style={styles.bg} resizeMode="cover">
      ...
      <Text style={styles.phoneNumber}>Incoming videoCall...</Text>
